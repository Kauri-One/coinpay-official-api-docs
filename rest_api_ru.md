...
"invoice_order_limits": {
 ...
 ```javascript
 {
  ...
  Есть 3 опции - "COINPAY", "CRYPTO", "FIAT". Если не указывать этот параметр, то по-умолчанию будет установлена возможность оплаты счёта пользователем его средствами на платформе "COINPAY", в остальных двух случаях не нужна регистрация на платформе, плюс можно ограничить возможную оплату по счёту или только фиатными средствами, или крипто-средствами.
