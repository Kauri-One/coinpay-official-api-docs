...
- [Заявки](#заявки)
  ...
  - [Заявка на внутренний перевод](#заявка-на-внутренний-перевод)
    ...
    - [Получение деталей по заявке на внутренний перевод](#получение-деталей-по-заявке-на-внутренний-перевод)
    - [Детали заявки на внутренний перевод при callback нотификации](#детали-заявки-на-внутренний-перевод-при-callback-нотификации)
  - [Заявка на создание счёта(invoice)](#заявка-на-создание-счёта) 
    - [Схема работы заявки на создание счёта](#схема-работы-заявки-на-создание-счёта)  
...
1) создаеться счёт
2) счёт привязываеться к конкретному пользователю, который будет оплачивать(привязка может происходить или отдельной АПИ командой или во время оплаты)
2) пользователь переходит по ссылке(логиниться на сайте coinpay.com.ua) и может оплатить любой валютой.
